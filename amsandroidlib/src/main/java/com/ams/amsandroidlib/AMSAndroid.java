...
import com.ams.amsandroidlib.helpers.imagevalidation.ImageValidator;
import com.ams.amsandroidlib.helpers.reporter.Reporter;
import com.ams.amsandroidlib.helpers.reporter.Suite;
import com.ams.amsandroidlib.helpers.uiautomator.UiObjectActions;
import com.ams.amsandroidlib.helpers.uiautomator.UiObjectFinder;
...
public class AMSAndroid implements AMS {
    ...
    @Override
    public void verifyPage(String tagName){
        imageValidator.verifyPage(mDevice,tagName);
    }
